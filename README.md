...
| ------------------------------------------------------------ | ------------------------------------------------------------ | -------- | ------ | ---------- |
| [BiliBili自动添加视频收藏](https://scriptcat.org/zh-CN/script-show-page/1603/code) | 进入视频页面, 自动添加视频到收藏夹中                         | 前台脚本 | v0.6.2 | 2025-11-12 |
| Bilibili视频观看状态标记                                     | 通过收藏夹, 获取当前视频的观看状态 (已看 / 未看), 并在视频卡片处标记 | 前台脚本 | v1.0.0 | 2025-12-03 |
