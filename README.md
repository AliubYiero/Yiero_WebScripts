...
| 脚本名称 | 脚本描述 | 脚本类型 | 版本号 | 最后更新 | 安装#1 | 安装#2 | 安装#3 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Bilibili直播自动点赞 | Bilibili进入直播间后自动点赞. | 前台脚本 | 1.3.0 | 2026-05-15 | [Github 源](https://github.com/AliubYiero/Yiero_WebScripts/raw/refs/heads/main/src/com/bilibili/bilibili-live-auto-like/backup/bilibili-live-auto-like.user.js) |  |  |
