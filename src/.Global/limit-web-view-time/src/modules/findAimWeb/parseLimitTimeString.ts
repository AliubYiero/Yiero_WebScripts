 ...
 * */
export const parseLimitTimeString = (
    limitTimeString: string,
): LimitTime[] => {
    ...
    return limitTimeLineList.map<LimitTime>((item) => {
        ...
        const limitWay: LimitWay =
            LimitWay[limitWayKey as keyof typeof LimitWay];
