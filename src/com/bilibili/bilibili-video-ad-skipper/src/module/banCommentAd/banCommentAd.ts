...
const removeAdComment = (commentContainer: HTMLElement) => {
    ...
    const commentContentContainer =
        commentContainer.shadowRoot.querySelector<HTMLElement>(
    ...
    const richContentContainer =
        commentContentContainer.shadowRoot!.querySelectorAll<HTMLElement>(
            'bili-rich-text',
        );
...
export const banCommentAd = async () => {
    const commentContainer = await elementWaiter('bili-comments', {
    ...
    commentContentContainer
        .querySelectorAll<HTMLElement>('bili-comment-thread-renderer')
