...
```typescript
function api_getSeasonSectionInfo(sectionId: number, login?: boolean): Promise<XhrResponse<ISeasonSectionInfo>>
```
...
```typescript
import { api_getSeasonSectionInfo } from '@yiero/bilibili-api-lib';
