...
(function (exports) {
    ...
    let y$1 = class y extends HTMLElement {
        ...
        _$ET(t2, s2) {
            ...
            if (void 0 !== e2 && true === i2.reflect) {
                const h2 = (
                    void 0 !== i2.converter?.toAttribute
                        ? i2.converter
                        : u$1
        ...
        _$AK(t2, s2) {
            ...
            if (void 0 !== e2 && this._$Em !== e2) {
                ...
                (this[e2] = r2 ?? this._$Ej?.get(e2) ?? r2),
                    (this._$Em = null);
            }
        }
        ...
        C(t2, s2, { useDefault: i2, reflect: e2, wrapped: h2 }, r2) {
            (i2 &&
                ...
                true === e2 &&
                    this._$Em !== t2 &&
                    (this._$Eq ??= /* @__PURE__ */ new Set()).add(
                        t2,
                    ));
        }
        async _$EP() {
    ...
    const t$1 = globalThis,
        ...
        u = Array.isArray,
        d = (t2) =>
            u(t2) || 'function' == typeof t2?.[Symbol.iterator],
        f = '[ 	\n\f\r]',
        v = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
        _ = /-->/g,
        m = />/g,
...
\f\r"'\`<>=]|("|')|))|$)`,
    ...
    class R {
        ...
        u(t2) {
            const {
                ...
                e2 = (t2?.creationScope ?? l).importNode(i2, true);
            P.currentNode = e2;
            let h2 = P.nextNode(),
                o2 = 0,
                n2 = 0,
    ...
    class i extends y$1 {
        ...
        createRenderRoot() {
            ...
            return (
                (this.renderOptions.renderBefore ??= t2.firstChild),
                t2
            );
        }
        update(t2) {
    ...
    let HistoryModal = class extends i {
        ...
        downloadSession(sessionTime) {
            ...
            a2.href = url;
            a2.download = `\u76F4\u64AD\u8BB0\u5F55-${this.formatDate(session.liveStartTime)}.json`;
            a2.click();
