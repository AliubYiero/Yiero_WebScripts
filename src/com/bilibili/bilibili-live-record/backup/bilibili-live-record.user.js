...
(function (exports) {
    ...
    const clearChatInputRadius = () => {
        GM_addStyle(
            `#chat-control-panel-vm {border-radius: 0 !important;}`,
        );
    };
            ...
            if (e$2)
                ...
                for (const e2 of o2) {
                    const o3 = document.createElement('style'),
                        n2 = t$2.litNonce;
                    void 0 !== n2 && o3.setAttribute('nonce', n2),
    ...
    let y$1 = class y extends HTMLElement {
        ...
        static get observedAttributes() {
            return (
                this.finalize(), this._$Eh && [...this._$Eh.keys()]
            );
        }
        static createProperty(t2, s2 = b$1) {
            if (
                ...
                const i2 = Symbol(),
                    h2 = this.getPropertyDescriptor(t2, i2, s2);
        ...
        static getPropertyDescriptor(t2, s2, i2) {
            ...
            return {
                ...
                set(s3) {
                    ...
                    r2 == null ? void 0 : r2.call(this, s3),
                        this.requestUpdate(t2, h2, i2);
                },
                configurable: true,
                enumerable: true,
            };
        ...
        addController(t2) {
            var _a2;
            (
                this._$EO ?? (this._$EO = /* @__PURE__ */ new Set())
            ).add(t2),
                void 0 !== this.renderRoot &&
                    this.isConnected &&
                    ((_a2 = t2.hostConnected) == null
                        ? void 0
                        : _a2.call(t2));
        }
        removeController(t2) {
        ...
        _$E_() {
            ...
            for (const i2 of s2.keys())
                this.hasOwnProperty(i2) &&
                    (t2.set(i2, this[i2]), delete this[i2]);
        ...
        connectedCallback() {
            ...
            this.renderRoot ??
                ...
                (_a2 = this._$EO) == null
                    ...
                    : _a2.forEach((t2) => {
                          var _a3;
                          return (_a3 = t2.hostConnected) == null
                              ? void 0
                              : _a3.call(t2);
                      });
        }
        ...
        disconnectedCallback() {
            ...
            (_a2 = this._$EO) == null
                ...
                : _a2.forEach((t2) => {
                      var _a3;
                      return (_a3 = t2.hostDisconnected) == null
                          ? void 0
                          : _a3.call(t2);
                  });
        }
        ...
        _$ET(t2, s2) {
            var _a2;
            const i2 = this.constructor.elementProperties.get(t2),
                e2 = this.constructor._$Eu(t2, i2);
            if (void 0 !== e2 && true === i2.reflect) {
                const h2 = (
                    void 0 !==
                    ((_a2 = i2.converter) == null
                        ? void 0
                        : _a2.toAttribute)
                        ? i2.converter
                        : u$1
                ).toAttribute(s2, i2.type);
                (this._$Em = t2),
                    null == h2
                        ? this.removeAttribute(e2)
                        : this.setAttribute(e2, h2),
                    (this._$Em = null);
            }
        }
        _$AK(t2, s2) {
        ...
        requestUpdate(t2, s2, i2, e2 = false, h2) {
            ...
            if (void 0 !== t2) {
                ...
                if (
                    (false === e2 && (h2 = this[t2]),
                    i2 ?? (i2 = r2.getPropertyOptions(t2)),
                    !(
                        (i2.hasChanged ?? f$1)(h2, s2) ||
                        (i2.useDefault &&
                            i2.reflect &&
                            h2 ===
                                ((_a2 = this._$Ej) == null
                                    ? void 0
                                    : _a2.get(t2)) &&
                            !this.hasAttribute(r2._$Eu(t2, i2)))
                    ))
                )
                    return;
                this.C(t2, s2, i2);
            }
            false === this.isUpdatePending &&
                (this._$ES = this._$EP());
        }
        C(t2, s2, { useDefault: i2, reflect: e2, wrapped: h2 }, r2) {
            (i2 &&
                !(
                    this._$Ej ??
                    (this._$Ej = /* @__PURE__ */ new Map())
                ).has(t2) &&
                (this._$Ej.set(t2, r2 ?? s2 ?? this[t2]),
                true !== h2 || void 0 !== r2)) ||
                (this._$AL.has(t2) ||
                    (this.hasUpdated || i2 || (s2 = void 0),
                    this._$AL.set(t2, s2)),
                true === e2 &&
                    this._$Em !== t2 &&
                    (
                        this._$Eq ??
                        (this._$Eq = /* @__PURE__ */ new Set())
                    ).add(t2));
        }
        async _$EP() {
        ...
        _$AE(t2) {
            ...
            (_a2 = this._$EO) == null
                ...
                : _a2.forEach((t3) => {
                      var _a3;
                      return (_a3 = t3.hostUpdated) == null
                          ? void 0
                          : _a3.call(t3);
                  }),
                this.hasUpdated ||
                    ((this.hasUpdated = true), this.firstUpdated(t2)),
                this.updated(t2);
        }
        _$EM() {
            (this._$AL = /* @__PURE__ */ new Map()),
        ...
        update(t2) {
            this._$Eq &&
                (this._$Eq = this._$Eq.forEach((t3) =>
                    this._$ET(t3, this[t3]),
                )),
                this._$EM();
        }
        updated(t2) {}
    ...
    (y$1.elementStyles = []),
        ...
        p$1 == null ? void 0 : p$1({ ReactiveElement: y$1 }),
        (
    ...
    const t$1 = globalThis,
        i$1 = (t2) => t2,
        s$1 = t$1.trustedTypes,
        e = s$1
            ? s$1.createPolicy('lit-html', { createHTML: (t2) => t2 })
            : void 0,
        h = '$lit$',
        ...
        d = (t2) =>
            u(t2) ||
            'function' ==
                typeof (t2 == null ? void 0 : t2[Symbol.iterator]),
        f = '[ 	\n\f\r]',
        v = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
        _ = /-->/g,
        m = />/g,
...
\f\r"'\`<>=]|("|')|))|$)`,
                        ...
                        : c2 === p
                          ...
                          : c2 === $ || c2 === g
                            ...
                            : c2 === _ || c2 === m
                              ...
                              : ((c2 = p), (n2 = void 0));
            const x2 =
                c2 === p && t2[i3 + 1].startsWith('/>') ? ' ' : '';
            l2 +=
                c2 === v
                    ? s3 + r$2
                    : d2 >= 0
                      ? (e2.push(a2),
                        s3.slice(0, d2) + h + s3.slice(d2) + o$2 + x2)
                      : s3 + o$2 + (-2 === d2 ? i3 : x2);
        }
        return [
            V(
            ...
            for (; null !== (r2 = P.nextNode()) && d2.length < u2; ) {
                if (1 === r2.nodeType) {
                    ...
                    if (y.test(r2.tagName)) {
                        const t3 = r2.textContent.split(o$2),
                            i3 = t3.length - 1;
                        if (i3 > 0) {
                            r2.textContent = s$1
                                ? s$1.emptyScript
                    ...
                    if (r2.data === n$1)
                        ...
                        for (
                            ;
                            -1 !==
                            (t3 = r2.data.indexOf(o$2, t3 + 1));
                        )
                            d2.push({ type: 7, index: l2 }),
                                (t3 += o$2.length - 1);
                    }
                l2++;
            }
    ...
    function M(t2, i2, s2 = t2, e2) {
        ...
        return (
            (h2 == null ? void 0 : h2.constructor) !== o2 &&
                ((_b = h2 == null ? void 0 : h2._$AO) == null
                    ? void 0
                    : _b.call(h2, false),
                void 0 === o2
                    ? (h2 = void 0)
                ...
                void 0 !== e2
                    ? ((s2._$Co ?? (s2._$Co = []))[e2] = h2)
                    : (s2._$Cl = h2)),
            void 0 !== h2 &&
                (i2 = M(t2, h2._$AS(t2, i2.values), h2, e2)),
            i2
        );
    }
    class R {
        ...
        u(t2) {
            const {
                ...
                e2 = (
                    (t2 == null ? void 0 : t2.creationScope) ?? l
                ).importNode(i2, true);
            P.currentNode = e2;
            let h2 = P.nextNode(),
                o2 = 0,
    ...
    class k {
        get _$AU() {
            var _a2;
            return (
                ((_a2 = this._$AM) == null ? void 0 : _a2._$AU) ??
                this._$Cv
            );
        }
        constructor(t2, i2, s2, e2) {
            (this.type = 2),
                ...
                (this.options = e2),
                (this._$Cv =
                    (e2 == null ? void 0 : e2.isConnected) ?? true);
        }
        get parentNode() {
        ...
        T(t2) {
            this._$AH !== t2 &&
                (this._$AR(), (this._$AH = this.O(t2)));
        }
        _(t2) {
            this._$AH !== A && a(this._$AH)
                ? (this._$AA.nextSibling.data = t2)
                : this.T(l.createTextNode(t2)),
                (this._$AH = t2);
        }
        $(t2) {
            var _a2;
            const { values: i2, _$litType$: s2 } = t2,
                e2 =
                    'number' == typeof s2
                        ? this._$AC(t2)
                        : (void 0 === s2.el &&
                              (s2.el = S.createElement(
                                  V(s2.h, s2.h[0]),
                                  this.options,
                              )),
                          s2);
            if (
                ((_a2 = this._$AH) == null ? void 0 : _a2._$AD) === e2
            )
                this._$AH.p(i2);
            else {
        ...
        _$AC(t2) {
            ...
            return (
                void 0 === i2 && C.set(t2.strings, (i2 = new S(t2))),
                i2
            );
        }
        k(t2) {
            ...
            for (const h2 of t2)
                e2 === i2.length
                    ...
                    e2++;
            e2 < i2.length &&
                (this._$AR(s2 && s2._$AB.nextSibling, e2),
                (i2.length = e2));
        }
        ...
        constructor(t2, i2, s2, e2, h2) {
            (this.type = 1),
                ...
                s2.length > 2 || '' !== s2[0] || '' !== s2[1]
                    ? ((this._$AH = Array(s2.length - 1).fill(
                          new String(),
                      )),
                      (this.strings = s2))
                    : (this._$AH = A);
    ...
    class z extends H {
        ...
        _$AI(t2, i2 = this) {
            ...
            const s2 = this._$AH,
                ...
                h2 = t2 !== A && (s2 === A || e2);
            e2 &&
                this.element.removeEventListener(this.name, this, s2),
                h2 &&
    ...
    B == null ? void 0 : B(S, k),
        (t$1.litHtmlVersions ?? (t$1.litHtmlVersions = [])).push(
            '3.3.2',
        );
    const D = (t2, i2, s2) => {
        ...
        if (void 0 === h2) {
            const t3 =
                (s2 == null ? void 0 : s2.renderBefore) ?? null;
            e2._$litPart$ = h2 = new k(
                i2.insertBefore(c(), t3),
                t3,
                void 0,
                s2 ?? {},
            );
    ...
    (i._$litElement$ = true),
        (i['finalized'] = true),
        (_a = s.litElementHydrateSupport) == null
            ? void 0
            : _a.call(s, { LitElement: i });
    const o$1 = s.litElementPolyfillSupport;
    o$1 == null ? void 0 : o$1({ LitElement: i });
    (s.litElementVersions ?? (s.litElementVersions = [])).push(
        '4.2.2',
    );
    /**
     * @license
    ...
    const o = {
        ...
        r$1 = (t2 = o, e2, r2) => {
            ...
            if (
                ...
                'setter' === n2 &&
                    ((t2 = Object.create(t2)).wrapped = true),
                s2.set(r2.name, t2),
                'accessor' === n2)
            ) {
                const { name: o2 } = r2;
                return {
                    set(r3) {
                        ...
                        e2.set.call(this, r3),
                            this.requestUpdate(o2, n3, t2, true, r3);
                    },
                    init(e3) {
                        return (
                            void 0 !== e3 &&
                                this.C(o2, void 0, t2, e3),
                            e3
                        );
                    },
                };
        ...
        return (e2, o2) =>
            'object' == typeof o2
                ...
                : ((t3, e3, o3) => {
                      ...
                      return (
                          e3.constructor.createProperty(o3, t3),
                          r2
    ...
    let TimestampRecorder = class extends i {
            ...
            if (
                ...
                if (
                    ((_a2 = this.shadowRoot) == null
                        ? void 0
                        : _a2.activeElement) === this.textarea
                ) {
                    this.blurInput();
                } else {
                    this.focusInput();
        ...
        get textarea() {
            ...
            return (
                ((_a2 = this.shadowRoot) == null
                    ? void 0
                    : _a2.querySelector('textarea')) || null
            );
        }
        /**
         * 输入框聚焦事件处理器
        ...
        handleOpenRecordList() {
            this.dispatchEvent(
                new CustomEvent('open-record-list', {
                    bubbles: true,
                    composed: true,
                }),
            );
        ...
        handleSubmit() {
            ...
            this.dispatchEvent(
                new CustomEvent('timestamp-recorded', {
                    detail,
                    bubbles: true,
                    composed: true,
                }),
    ...
    const initTimestampRecorder = async (
        liveStartTime = 0,
        isLive = true,
    ) => {
        const timestampRecorder = document.createElement(
            'timestamp-recorder',
        );
    ...
    let HistoryModal = class extends i {
        ...
        toggleSession(sessionTime) {
            this.expandedSession =
                this.expandedSession === sessionTime
                    ? 0
                    : sessionTime;
        }
        downloadSession(sessionTime) {
            const session = this.historyData.find(
                (s2) => s2.liveStartTime === sessionTime,
            );
            if (!session) return;
            this.dispatchEvent(
    ...
    __decorateClass([n()], HistoryModal.prototype, 'historyData', 2);
    ...
    const main = async () => {
        ...
        const historyModal = await initHistoryModal(
            Number(roomId),
            recordStorage.get(),
        );
        ...
        historyModal.addEventListener('download-session', (e2) => {
            ...
            a2.href = url;
            const dateContent = new Date(session.liveStartTime)
                .toLocaleString()
                .replace(/[\/:]/g, '-');
        ...
        const timestampRecorder = await initTimestampRecorder(
            data.liveTime,
            data.isLive,
        );
        timestampRecorder.addEventListener(
            'timestamp-recorded',
            (e2) => {
                const recordInfo = recordStorage.get();
                const recordItem = recordInfo.find(
                    (item) =>
                        item.liveStartTime ===
                        e2.detail.liveStartTime,
                );
                const mark = {
                    id: 1,
