...
`;
  ...
  const addKeyStore = new GmStorage("\u5FEB\u6377\u952E\u914D\u7F6E.addKey", "X");
  ...
  const reduceKeyStore = new GmStorage("\u5FEB\u6377\u952E\u914D\u7F6E.reduceKey", "Z");
  ...
  const main = async () => {
    ...
    const handlePlaybackChange = (type) => {
      const playbackRateValue = type === "add" ? playbackRate.add() : playbackRate.reduce();
