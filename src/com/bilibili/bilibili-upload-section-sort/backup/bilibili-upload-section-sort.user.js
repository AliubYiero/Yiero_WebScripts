...
(function() {
  ...
  const hookXhr = (hookUrl, callback) => {
    ...
    XMLHttpRequest.prototype.open = function(method, url, async = true, username, password) {
      ...
      if (matchedHook) {
        ...
        if (!(descriptor == null ? void 0 : descriptor.get)) return originalXhrOpen.call(this, method, url, async, username, password);
  ...
  function recalculateMessagePositions() {
    ...
    for (const msg of activeMessages) {
      ...
      (_a = positionGroups.get(pos)) == null ? void 0 : _a.push(msg);
    }
...
`;
  class SortButton extends HTMLElement {
    ...
    updateStatusDisplay() {
      var _a;
      const container = (_a = this.shadowRoot) == null ? void 0 : _a.querySelector(
        ".sort-button-group"
      );
      if (container) {
    ...
    updateCountdownDisplay() {
      var _a;
      const el = (_a = this.shadowRoot) == null ? void 0 : _a.querySelector(".loading-button");
      if (el) {
    ...
    addEventListeners() {
      var _a, _b, _c, _d;
      (_b = (_a = this.shadowRoot) == null ? void 0 : _a.querySelector(".ascend-sort-button")) == null ? void 0 : _b.addEventListener("click", this.handleAscendClick);
      (_d = (_c = this.shadowRoot) == null ? void 0 : _c.querySelector(".descend-sort-button")) == null ? void 0 : _d.addEventListener("click", this.handleDescendClick);
    }
    removeEventListeners() {
      var _a, _b, _c, _d;
      (_b = (_a = this.shadowRoot) == null ? void 0 : _a.querySelector(".ascend-sort-button")) == null ? void 0 : _b.removeEventListener("click", this.handleAscendClick);
      (_d = (_c = this.shadowRoot) == null ? void 0 : _c.querySelector(".descend-sort-button")) == null ? void 0 : _d.removeEventListener("click", this.handleDescendClick);
    }
  }
  ...
  const fetchEpisodePubtimes = async (episodes, cache, onProgress) => {
  ...
  const executeSectionSort = async (videoPublishInfoList, section, sortOrder) => {
  ...
  const formatDate = (second) => {
    const timestamp = String(second).length === 10 ? second * 1e3 : second;
...
`;
  ...
  const publishTimeStore = new GmStorage(
    "publishTime",
    {}
  );
  ...
  const handleSeasonData = async (response) => {
    ...
    if (processedSeasonIds.has(seasonId) && document.querySelector("sort-button")) {
    ...
    colList.forEach((colElement) => {
      var _a;
      const videoUrl = (_a = colElement.querySelector(
