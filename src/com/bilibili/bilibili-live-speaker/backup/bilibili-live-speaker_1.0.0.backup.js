...
(function () {
    ...
    `;
        ...
        clearAllErrors() {
            ...
            const errors =
                this.shadow.querySelectorAll('.error-message');
        ...
        bindEvents() {
            ...
            const btnCancel =
                this.shadow.getElementById('btn-cancel');
            const btnSave = this.shadow.getElementById('btn-save');
            const textInput =
                this.shadow.getElementById('config-text');
            ...
            const textError =
                this.shadow.getElementById('text-error');
            const repeatError =
            ...
            btnSave == null
                ...
                : btnSave.addEventListener('click', () => {
                      ...
                      const repeatMin = parseInt(
                          (repeatMinInput == null
                              ? void 0
                              : repeatMinInput.value) || '1',
                      );
                      const repeatMax = parseInt(
                          (repeatMaxInput == null
                              ? void 0
                              : repeatMaxInput.value) || '1',
                      );
                      ...
                      if (
                          ...
                          hasError = true;
                          firstErrorInput =
                              firstErrorInput || repeatMinInput;
                      }
                      if (
                          !hasError &&
                          ...
                          hasError = true;
                          firstErrorInput =
                              firstErrorInput || repeatMaxInput;
                      }
                      if (
                          !hasError &&
                          (isNaN(minVal) || minVal < 500)
                      ) {
                          this.showError(
                              minInput,
                              intervalError,
                          ...
                          hasError = true;
                          firstErrorInput =
                              firstErrorInput || minInput;
                      }
                      if (
                          !hasError &&
                          (isNaN(maxVal) || maxVal < minVal)
                      ) {
                          this.showError(
                              maxInput,
                              intervalError,
    ...
    class Danmaku {
        ...
        init() {
            ...
            this.submitButton = document.querySelector(
                '.bl-button.live-skin-highlight-button-bg.live-skin-button-text',
            );
        }
        send(content) {
        ...
        const sendDanmaku = (config2, maxContentLength = 40) => {
            danmaku.send(
                config2.text
                    .repeat(
                        getRandomInt(
                            config2.repeatCount.min,
                            config2.repeatCount.max,
                        ),
                    )
                    .slice(0, maxContentLength),
            );
            const nextSendTime = getRandomInt(
                config2.interval.min,
                config2.interval.max,
            );
