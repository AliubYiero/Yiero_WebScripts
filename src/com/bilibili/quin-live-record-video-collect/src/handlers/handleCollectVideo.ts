...
const parserMapper = new Map<
    string,
    (container: HTMLElement) => CollectInfo | null
>();
parserMapper.set(
    '245335',
    (container: HTMLElement): CollectInfo | null => {
        ...
        const linkElement =
            titleElement!.querySelector<HTMLAnchorElement>(
                '.bili-video-card__title > a',
            )!;
        if (!linkElement) return null;
        const liveDurationElement =
