 ...
 */
declare function CAT_setProxy(
    rule: CATType.ProxyRule[] | string,
): void;
...
declare namespace GMTypes {
    ...
    interface XHRDetails {
        ...
        onerror?: (
            err: string | (XHRResponse & { error: string }),
        ) => void;
    }
