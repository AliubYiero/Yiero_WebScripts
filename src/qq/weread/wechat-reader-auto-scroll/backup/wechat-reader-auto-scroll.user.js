...
(function () {
    ...
    class PageBottomBlankStyle {
        static add(height) {
            this.styleElement = GM_addStyle(
                `.readerFooter {min-height: ${height}px;`,
            );
        }
        static remove() {
